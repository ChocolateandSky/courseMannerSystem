<template>
  <div class="app-container">
    <el-container>
      <!-- 头部内容 -->
      <el-header>
        <el-button type="success" icon="el-icon-plus" style="float: left" @click="addDialogVisible = true">新增</el-button>
        <div class="searchBox">
          <el-input
            v-model="searchInfo"
            placeholder="请输入内容"
    ...
    >
      <el-form ref="editFormRef" :model="editForm" label-width="80px">
        <el-form-item label="课程名称:" prop="courseName">
          <el-input v-model="editForm.courseName" :style="{width: '80%'}" />
        </el-form-item>
        <el-form-item label="管理员:" prop="admin">
          <el-input v-model="editForm.admin" :style="{width: '80%'}" />
        </el-form-item>
        <el-form-item label="容量" prop="sum">
...
export default {
  ...
  data() {
    return {
      ...
      pageSize: 5, // 页面显示内容大小
      // 添加课程设计对话框内容
      addDialogVisible: false, // 控制添加课程设计对话框的显示与隐藏，默认为隐藏
      addForm: {},
      // 修改课程设计对话框内容
      editDialogVisible: false, // 控制修改课程设计对话框的显示与隐藏，默认为隐藏
      editForm: {
        courseName: '',
        admin: '',
        date: '',
